...
const Events = () => {
  ...
  // Use the scroll hook to ensure the page scrolls to top on load
  useScrollTop({
  ...
  const filteredEvents = activeCategory === "All"
    ? events
    : events.filter(event => event.tags.includes(activeCategory));
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          >
            ...
            <p className="text-gray-200 max-w-2xl mx-auto text-lg font-jetbrains-mono bg-black/30 p-4 rounded-lg border border-cyan-500/20 shadow-lg shadow-cyan-500/5">
              <TerminalEffect text="Join us for exciting workshops, hackathons, and tech talks. Stay at the cutting edge of technology." />
            </p>
          </motion.div>

          {/* Event Cards - render all at once instead of staggered */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredEvents.map((event, index) => (
              ...
              >
                ...
                {/* Event Image with lighter overlay - simplified transition */}
